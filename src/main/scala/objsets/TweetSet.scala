...
object GoogleVsApple {
  ...
  def filterBy(keywords: List[String]): TweetSet = {
    var res: TweetSet = new Empty
    keywords.foreach(x => res = res.union(TweetReader.allTweets.filter(tweet => tweet.text.contains(x))))
    res    
  }  
